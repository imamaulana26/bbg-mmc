        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#log" data-toggle="tab">Log Error</a></li>
                </ul>
            ...
            <div class="modal-body">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="step7<?= $dt->no_fos ?>">
                        ...
                        <?php } else { ?>
						<div class="modal-footer">
                            <button type="submit" name="reject" value="Revisi Reviewer" class="btn btn-default">
                                Back to Reviewer <i class="glyphicon glyphicon-refresh"></i>
                            </button>
                        </div>
						<?php } ?>
                    </div>
