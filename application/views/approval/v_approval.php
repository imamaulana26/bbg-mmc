    ...
    <div class="row">
        ...
        if (!empty($proses)) { ?>
            ...
            <div class="alert alert-success fade in">
                ...
                <i class="glyphicon glyphicon-refresh"></i> <?= $proses ?>
            </div>
        <?php } ?>
            ...
            <div class="panel panel-default">
                <div class="panel-heading" style="cursor: pointer">
                    <h3 class="panel-title">
                        <i class="glyphicon glyphicon-tasks"></i>&nbsp;Detail Data Proses Pembiayaan
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading" style="cursor: pointer">
                        <h3 class="panel-title">
                            <i class="glyphicon glyphicon-tasks"></i>&nbsp;Data Hasil Pencairan Berhasil
                            <span class="pull-right">
                                <i class="glyphicon glyphicon-minus"></i>
                            </span>
                        </h3>
