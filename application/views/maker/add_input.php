                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <?php foreach($userCab->result() as $li){
                                            foreach($cabang as $cab){
                                                if($li->cabang == $cab->kd_cabang){
                                                    echo "<input type='text' name='kd_cabang' class='form-control' value='".$cab->kd_cabang." - ".$cab->nama_cabang."' readonly>";
                                                }
                                            }
                                        } ?>
                                    </div>
