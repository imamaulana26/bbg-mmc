	...
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="panel panel-default">
				...
				<form method="post" id="formValid" action="<?= site_url('maker/link/simpanData') ?>" class="form-horizontal">
				...
				<div class="panel-footer">
					<div class="btn-groups">
						<a href="<?= site_url('maker/anak/edit_anak/').$row->no_fos ?>" class="btn btn-default"><i class="glyphicon glyphicon-chevron-left"></i> Back</a>
