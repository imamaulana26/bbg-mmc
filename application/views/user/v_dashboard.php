        ...
        <ul class="nav navbar-top-links navbar-right">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    ...
                    <li class="divider"></li>
                    <li><a href="<?= site_url('c_login/logout') ?>"><i class="fa fa-sign-out fa-fw"></i> Logout</a></li>
                </ul>
                <!-- /.dropdown-user -->
            </li>
            <!-- /.dropdown -->
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    <li><a href="<?= site_url('user/c_dashboard') ?>"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a></li>
                </ul>
            </div>
            <!-- /.sidebar-collapse -->
        </div>
