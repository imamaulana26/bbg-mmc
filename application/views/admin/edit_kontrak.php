					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" class="form-control" value="<?= $row->cif ?>">
								</div>
							</div>
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" name="kode_unit" class="form-control" value="<?= $row->kode_unit_kerja ?>">
								</div>
							</div>
							<div class="col-md-4 col-md-offset-4">
								<div class="form-group">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" name="segmen_produk" class="form-control" value="<?= $row->segmentasi ?>">
								</div>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									<input type="text" name="no_limit" class="form-control" value="<?= $row->no_limit ?>">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" name="rek_margin" class="form-control" value="<?= $row->rek_margin ?>">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-md-3">
								<div class="form-group">
									<label>% Margin</label>
									<input type="text" name="margin" class="form-control" placeholder="Ex. 2.03%" value="<?= $row->margin ?>">
								</div>
							</div>
							<div class="col-md-6 col-md-offset-3">
								<div class="form-group">
									<label>Total Margin</label>
									<input type="text" name="total_margin" class="form-control" value="<?= $row->total_margin ?>" readonly>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="radio-inline">
								<label class="radio-inline">
									<input type="radio" name="teratribusi" value="NO" <?php if($row->teratribusi == "NO") echo "checked"; ?>>NO
								</label>
								<label class="radio-inline">
									<input type="radio" name="teratribusi" value="YES" <?php if($row->teratribusi == "YES") echo "checked"; ?>>YES
								</label>
							</div>
						</div>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									foreach($data as $key=>$dt){
										$select = '';
										if($key == $row->kode_biaya) $select = 'selected';
