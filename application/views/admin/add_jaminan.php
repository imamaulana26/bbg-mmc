				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" name="tipe_jaminan" class="form-control" value="82">
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
				...
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input type="text" name="njop" id="njop" class="form-control" value="<?= number_format($row->nom_fasilitas, 0, '.', ',') ?>">
						</div>
					</div>
				</div>
			</div>
